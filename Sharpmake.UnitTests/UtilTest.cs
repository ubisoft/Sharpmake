...
namespace SharpmakeUnitTests
{
    ...
    public class StringsOperations
    {
        ...
        {
            ITarget target1 = new Target(Platform.win64, DevEnv.vs2017, Optimization.Release, OutputType.Dll, Blob.Blob, BuildSystem.FastBuild, DotNetFramework.v2);
            ITarget target2 = new Target(Platform.win64, DevEnv.vs2017, Optimization.Release, OutputType.Dll, Blob.Blob, BuildSystem.FastBuild, DotNetFramework.v2);
            ...
            Assert.True(Util.MakeDifferenceString(target1, target3).Contains("\"net20\" and \"net45\""));

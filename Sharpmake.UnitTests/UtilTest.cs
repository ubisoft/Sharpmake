...
namespace Sharpmake.UnitTests
{
    ...
    public class StringsOperations
    {
        ...
        {
            ITarget target1 = new Target(Platform.win64, DevEnv.vs2017, Optimization.Release, OutputType.Dll, Blob.Blob, BuildSystem.FastBuild, DotNetFramework.v3);
            ITarget target2 = new Target(Platform.win64, DevEnv.vs2017, Optimization.Release, OutputType.Dll, Blob.Blob, BuildSystem.FastBuild, DotNetFramework.v3);
            ...
            Assert.True(Util.MakeDifferenceString(target1, target3).Contains("\"net30\" and \"net45\""));
